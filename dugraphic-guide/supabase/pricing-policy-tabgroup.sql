...
set blocks = $tpl$[
  ...
  {"type":"table","content":{"type":"tableContent","rows":[{"cells":["항목","등록/갱신 (연)"]},{"cells":[".com","약 20,000원~"]},{"cells":[".co.kr","약 22,000원~"]},{"cells":[".kr","약 20,000원~"]},{"cells":[".shop","약 30,000원~"]},{"cells":[".site","약 20,000원~"]}]}},
  {"type":"paragraph","content":"위 가격은 참고용 평균가이며, 실제 가격은 도메인 이름과 프로모션에 따라 달라질 수 있습니다. 정확한 가격은 아래 검색을 통해 확인해주세요."},
  {"type":"domainSearch"},
